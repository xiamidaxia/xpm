 ...
 */
function _execFileByContext(filepath, context, noRequire) {
    ...
    filecode = "(function("+keys.join(",")+"){'use strict';" + filecode + "\n})"
...
exports.execFileByContext = _execFileByContext
exports.getRequireFn = getRequireFn
exports.prettyCode = require('./prettyCode')
