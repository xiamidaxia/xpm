...
it("minimongo - selector and projection combination", function(done) {
    ...
    testSelProjectionComb({ $or: [
        { a: 1234, e: {$lt: 5} }
    ], b: 2 }, { b: 1, c: 1, d: 1 }, { a: true, b: true, c: true, d: true, e: true }, "simplest incl, branching");
    ...
    testSelProjectionComb({ $or: [
        { a: 1234, e: {$lt: 5} }
    ], b: 2 }, { b: 0, c: 0, d: 0 }, { c: false, d: false }, "simplest excl, branching");
    testSelProjectionComb({
        'a.b': { $lt: 3 },
        'y.0': -1,
        'a.c': 15
...
it("minimongo - sorter and projection combination", function(done) {
...
(function() {
    ...
    it("minimongo - can selector become true by modifier - literals (structured tests)", function(done) {
        test = t;
    ...
    it("minimongo - can selector become true by modifier - literals (adhoc tests)", function(done) {
        test = t;
    ...
    it("minimongo - can selector become true by modifier - regexps", function(done) {
        test = t;
    ...
    it("minimongo - can selector become true by modifier - undefined/null", function(done) {
        test = t;
        // Nulls / Undefined
    ...
    it("minimongo - can selector become true by modifier - literals with arrays", function(done) {
        test = t;
    ...
    it("minimongo - can selector become true by modifier - set an object literal whose fields are selected", function(done) {
        test = t;
    ...
    it("minimongo - can selector become true by modifier - $-scalar selectors and simple tests", function(done) {
        test = t;
    ...
    it("minimongo - can selector become true by modifier - $-nonscalar selectors and simple tests", function(done) {
        test = t;
