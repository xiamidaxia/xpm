...
var RoutePolicyConstructor = function () {
  var self = this;
  self.urlPrefixTypes = {};
};
...
_.extend(RoutePolicyConstructor.prototype, {
  ...
  checkForConflictWithStatic: function (urlPrefix, type, _testManifest) {
    ...
    */
    //add by xiamidaxia@gmail.com todo
    if (!_testManifest)  return null
...
var RoutePolicy = new RoutePolicyConstructor();

exports.RoutePolicy = RoutePolicy
exports.RoutePolicyConstructor = RoutePolicyConstructor
